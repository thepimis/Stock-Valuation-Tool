...
function isFile(filePath) {
  return fs2.statSync(filePath, { throwIfNoEntry: false })?.isFile() ?? false;
}
function isDirectory(filePath) {
  return fs2.statSync(filePath, { throwIfNoEntry: false })?.isDirectory() ?? false;
}
...
function pool_default(ctx) {
  ...
  return {
    ...
    async close() {
      ...
      allProjects.clear();
      log2.debug("Disposing remote proxy sessions...");
